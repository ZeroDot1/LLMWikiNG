...
*   **📥 Web Ingest & Ingest Later**: Convenient upload and text paste, as well as remembering URLs and notes in `ingestlater.md`.
...
*   **⚙️ Settings**: Central configuration page with tabs for language selection, **Appearance (Dark/Light)**, **User Management**, **API-Key Management**, SMTP email configuration, health check, and update function.
